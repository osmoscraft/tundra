...
export async function testFileV2StatusAhead() {
  ...
  fsm(db, "2. .. 1a | .. .. 3a | .. .. 3a"); // auto merge
  fsm(db, "2. .. 1a | .. .. 3b | .. .. 3b"); // auto merge
  fsm(db, "2. .. 1a | .. 3. .. | .. 3. 1a"); // auto resolve
  fsm(db, "2. .. 1a | .. 3a .. | 2. 3a 1a");
  ...
  fsm(db, "2b .. 1a | .. 3a .. | 2b 3a 1a");
  fsm(db, "2b .. 1a | .. 3b .. | .. 3b 1a"); // auto resolve
  fsm(db, "2b .. 1a | 3. .. .. | 3. .. 1a");
  ...
  fsm(db, "2a .. .. | .. .. 1b | 2a .. 1b");
  fsm(db, "3. .. 1a | .. 2. .. | .. 2. 1a"); // auto resolve
