...
import { SourceCodeElement } from "./modules/source-code/source-code-element";
...
customElements.define("source-code-element", SourceCodeElement);
...
export default function main() {
  ...
  const sourceCode = document.querySelector<SourceCodeElement>("source-code-element")!;
